...
function ThemeButtons({
  ...
  return (
    <div className="flex flex-col" onClick={handleClick}>
      <div
        className={` ${showBorder? borderActive : border} theme h-[1cm] w-[1cm] bg-tranparent shadow-inner rounded-md cursor-pointer flex justify-center relative py-2 border-2 `}
      >
        <div
